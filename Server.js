        ...
        if (map.get(req.query.uname)._randomstring == req.query.valid) {
            ...
            userloggedincheck(req, function (loggedin) {
                res.render('pages/registration', {
                    loggedin: loggedin,
                    username: req.cookies.user,
                    perror: "Invalid Validation Code"
                })
            });
        }
    } else {
        ...
        if (result == 'user not found' || result == 'user does not exist') {
            ...
            userloggedincheck(req, function (loggedin) {
                res.render('pages/registration', {
                    loggedin: loggedin,
                    username: req.cookies.user,
                    perror: "Invalid Credentials, Please try again"
                });
            });
        }
    });
            ...
            if (result != "user does not exist") {
                ...
                userloggedincheck(req, function (loggedin) {
                    res.render('pages/registration', {
                        loggedin: loggedin,
                        username: req.cookies.user,
                        perror: "Please validate your account before continuing"
                    })
                });
            }
        });
                            ...
                            Connection.getUsers(function (allusers) {
                                Connection.getPointsFromPost(req.body.text[index],function(numpoints){
                                    ...
                                    if (numpoints > userpercent){
                                        Connection.getUserEmailforSelectedword(req.body.text[index],function (result1) {
